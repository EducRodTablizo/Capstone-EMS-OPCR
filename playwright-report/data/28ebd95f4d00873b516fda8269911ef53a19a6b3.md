...
Call log:
  - waiting for getByRole('button', { name: 'Logout' })
    - locator resolved to <button class="flex w-full items-center gap-2 px-4 py-2 text-xs text-[#E24B4A] hover:bg-[#FCEBEB] transition-colors font-medium border-t border-border/50">…</button>
