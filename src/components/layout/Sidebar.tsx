...
import PUPLogo from '../../Asset/PUP_LOGO.png' // Inayos ang path
      ...
      <div className="px-6 py-5 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 flex items-center justify-center">
            {/* Ginamit na ang PUPLogo import */}
            <img src={PUPLogo} alt="PUP Caloocan logo" className="w-full h-full object-contain" />
          </div>
          <div>
